...
def main():
  ...
  here_api = "https://tce.api.here.com/2/calculateroute.json?app_id=bZy2SA4fCgNKrUVVIm8C&app_code=J5EBks4EB-i-B-x1t0waqQ"
  ...
  for fac in fac_number:
    ...
    for cus in cus_number:
      ...
      request_string = here_api + "&waypoint0=" + str(city_data[fac]['latitude'])+","+str(city_data[fac]['longitude'])+"&waypoint1="+ str(city_data[cus]['latitude'])+","+str(city_data[cus]['longitude'])+ "&mode=fastest;car" + cost_opt
